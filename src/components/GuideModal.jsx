    ...
    >
      ...
      >
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs leading-relaxed">
                미래의 나 혹은 친구에게 전하고 싶은 이야기를 작성합니다. 사진도
                함께 담을 수 있습니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center shrink-0 text-purple-400 font-bold text-sm">
              2
            </div>
            <div>
              <h4 className="text-white font-bold text-sm mb-1">봉인 설정</h4>
              <p className="text-slate-400 text-xs leading-relaxed">
                캡슐이 열릴 날짜와 시간을 정합니다. 암호키를 설정하면 더욱
                안전하게 보관됩니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <div className="w-8 h-8 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0 text-emerald-400 font-bold text-sm">
              3
            </div>
            <div>
          ...
          <div className="flex gap-4">
            <div className="w-8 h-8 rounded-full bg-amber-500/20 flex items-center justify-center shrink-0 text-amber-400 font-bold text-sm">
              4
            </div>
            <div>
              <h4 className="text-white font-bold text-sm mb-1">추억 개봉</h4>
              <p className="text-slate-400 text-xs leading-relaxed">
                지정된 시간이 되면 캡슐을 열 수 있습니다. 암호가 설정된 경우
                암호키가 필요합니다.
              </p>
            </div>
          </div>
